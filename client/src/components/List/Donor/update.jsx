...
const UpdateForm = () =>{
    ...
    function handleValidation()
    {
        ...
        else if(ndate.getFullYear()>today.getFullYear())
        {
            formIsValid=false;
            user.error="Please enter valid COVID-19 negative date";
        }
    ...
    const UpdateData = async(e) =>{
        ...
        {
        const {username, age, bloodgroup, organlist,positivedate, negativedate, phone, state, city}= user;
        ...
        const res=await fetch("http://localhost:5002/plasma/updatedonor", {
            ...
            body:JSON.stringify({
                username, age, bloodgroup, organlist, positivedate, negativedate, phone, state, city
            })
        });
