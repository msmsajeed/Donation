...
const DonorForm = () =>{
    ...
    function handleValidation()
    {
        ...
        {
            formIsValid=false;
            user.error="Age should be between 18 to 60. Please check the eligibility to donate organ.";
        } 
        else if(pdate.getFullYear()<=today.getFullYear())
        {
            ...
            {
                formIsValid=false;
                user.error="Please enter valid date of birthay date";
            }
        }
        ...
        else if(ndate.getFullYear()<=today.getFullYear() && ndate.getFullYear()>=pdate.getFullYear())
        {
            ...
            {
                formIsValid=false;
                user.error="Please enter valid donating date";
            }
        }
    ...
    const PostData = async(e) =>{
        ...
        {
        const {name ,username,password, gender, age, bloodgroup, organlist, positivedate, negativedate, phone, state, city}= user;
        ...
        const res=await fetch("http://localhost:5002/plasma/createdonor", {
            ...
            body:JSON.stringify({
                name ,username,password, gender, age, bloodgroup, organlist, positivedate, negativedate, phone, state, city
            })
        });
   ...
   /* const PostData = async(e) => {
    ...
    return(
                <div className="signup-form">
                    <h2 className="heading">Donate Organ</h2>
                    <Link to="/plasma"><p class="subtitle"> Please check the guidelines/eligibility to donate organ before submitting the form.</p></Link>
                <hr />    
                ...
                <div class="form-group">
                    <span className="labels">Organ Type *</span>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                        ...
                        class="form-control"
                        name="organlist" 
                        value={user.organlist} 
                        onChange={handleInputs}
                        placeholder="Enter your donating organ" 
                        required="required" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                <span className="labels">Planned to donate  *</span>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                                <i class="fa fa-paper-plane"></i>
                ...
                <div class="form-group">
                    <span className="labels">Province *</span>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                            <i class="fa fa-briefcase"></i>
