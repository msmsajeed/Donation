...
const RequestForm = () =>{
    ...
    function handleValidation()
    {
        ...
        if(pdate.getFullYear()<=today.getFullYear())
        {
            ...
            {
                formIsValid=false;
                user.error="Please enter valid DOB";
            }
        }
        else
        {
            formIsValid=false;
            user.error="Please enter valid donate date";
        }
        return formIsValid;
    }
    const PostData = async(e) =>{
        ...
        {
        const {name ,username,password, gender, age, bloodgroup, organlist, positivedate, phone, state, city}= user;
        ...
        const res=await fetch("http://localhost:5002/plasma/createrequester", {
            ...
            body:JSON.stringify({
                name ,username,password, gender, age, bloodgroup, organlist, positivedate, phone, state, city
            })
        });
 ...
 /*   const PostData = async(e) => {
    ...
    return(
                <div className="signup-form">
                    <h2 className="heading">Request Organ</h2>
                <hr />
